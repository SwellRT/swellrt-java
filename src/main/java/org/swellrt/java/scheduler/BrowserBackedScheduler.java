...
/**
 * Implementation of a scheduler using two optimised javascript object data
 * structures for the registry of jobs.
 * 
 * Adapted version to Android (pablojan@gmail.com) removing timing/stats and GWT
 * code.
 * 
